...
public class Csv {
    public static class Writer {
        ...
        public Writer(String fileName)  throws java.io.IOException { this(new File(fileName)); }
        public Writer(File file) throws java.io.IOException {
            appendable = new FileWriter(file);
        }
        public Writer(Appendable appendable) { this.appendable = appendable; }

        public Writer value(String value)  throws java.io.IOException {
        ...
        public Writer newLine()  throws java.io.IOException {
            first = true;
            return string("\n");
        }

        public Writer addLine(List<String> cells)  throws java.io.IOException {
            newLine();
        ...
        public Writer comment(String comment)  throws java.io.IOException {
        ...
        private Writer string(String s) throws java.io.IOException {
            appendable.append(s);
            return this;
        }
